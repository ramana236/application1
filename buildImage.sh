...
aws ecr get-login-password --region ap-south-1 --profile ramanapersonal | docker login --username AWS --password-stdin 202714190885.dkr.ecr.ap-south-1.amazonaws.com
